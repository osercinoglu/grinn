...
class DesignInteract(QMainWindow,grinnGUI_design.Ui_gRINN):
	...
	def __init__(self,parent=None):
		...
		self.label_3.setText(_translate("gRINN", "<html><head/><body><p><a href=\"http://grinn.readthedocs.io/en/v1.0.1/tutorial.html\"><span style=\" font-size:20pt; text-decoration: underline; color:#0000ff;\">Tutorial</span></a></p></body></html>"))
		self.label_4.setText(_translate("gRINN", "<html><head/><body><p><a href=\"http://grinn.readthedocs.io/en/v1.0.1/credits.html\"><span style=\" font-size:20pt; text-decoration: underline; color:#0000ff;\">Credits</span></a></p></body></html>"))
		self.label_5.setText(_translate("gRINN", "<html><head/><body><p><a href=\"http://grinn.readthedocs.io/en/v1.0.1/contact.html\"><span style=\" font-size:20pt; text-decoration: underline; color:#0000ff;\">Contact</span></a></p></body></html>"))
		self.label_6.setText(_translate("gRINN", "<html><head/><body><p><a href=\"http://grinn.readthedocs.io/en/v1.0.1/faq.html\"><span style=\" font-size:20pt; text-decoration: underline; color:#0000ff;\">FAQ</span></a></p></body></html>"))
