...
a = Analysis(['../grinn.py'],
             ...
             'pandas._libs.tslibs.nattype','pandas._libs.skiplist','scipy._lib.messagestream','PyQt5.sip','PyQt5.QtCore',
             'PyQt5.QtWidgets','PyQt5.QtGui','resultsGUI','resultsGUI_design','calcGUI','calcGUI_design','calc','corr',
             'common','grinnGUI_design','pen'],
             hookspath=[],
             runtime_hooks=[],
